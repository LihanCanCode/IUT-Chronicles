...
void Player::Move(float deltaTime, bool insideLibrary, bool insideClassroom, bool insideHospital, bool insideCDS, bool insideHall) {
   ...
   if(!insideLibrary && !insideClassroom && !insideHospital && !insideCDS && !insideHall){   
